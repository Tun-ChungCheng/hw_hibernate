...
<script type="text/javascript">
  function confirmDelete(userId){
	  var result = confirm("確定刪除此筆記錄(代號:" + userId + ")?");
	  if (result) {
  ...
  function confirmUpdate(userId){
	  var result = confirm("確定送出此筆記錄(代號:" + userId + ")?");
	  if (result) {
...
<hr>
<div class='center' >
<H1 class='center'>更新客戶資料</H1>
<hr>
<p> 
<form class='center' action="<c:url value='/lab01/updateCustomer.do' />" method="POST" >
    
    <input type="hidden" name="id"     value="${mb.id}${param.id}" >
    <input type="hidden" name="customerId"     value="${mb.customerId}${param.customerId}" >
    <input type="hidden" name="finalDecision" value="" > 
    <Table>
         <TR>
             <TD align="RIGHT">代號：</TD>
             <TD align="LEFT">${mb.customerId}${param.customerId}</TD>
         </TR>
         <TR>
        ...
        <TR>
            ...
            <input type="submit" value="更新" name='updateBtn' onclick="return confirmUpdate('${mb.customerId}');"> 
            <input type="submit" value="刪除" name='deleteBtn' onclick="return confirmDelete('${mb.customerId}');" >
            </TD>
            </TR>
         </Table>
...
<p/>
<small>&lt;&lt;<a href="<c:url value='/lab01/queryCustomer.do' />">回上一頁</a>&gt;&gt;</small>
</div>
</body>
</html>
